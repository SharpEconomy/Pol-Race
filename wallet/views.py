...
# Initialize Web3 connection using Alchemy Base mainnet RPC
ALCHEMY_URL = os.environ.get("ALCHEMY_BASE_RPC_URL", "https://base-mainnet.g.alchemy.com/v2/your_api_key")
